...
public class NativeConnectionPool {
	...
	static private NativeConnectionPool self_ = new NativeConnectionPool();
	...
	String url_ = "jdbc:db2://9.125.73.41:50001/PMR_CQDB";
	String user_ = "db2inst3";
	...
	private NativeConnectionPool()
	{
	}

	static public synchronized NativeConnectionPool instance()
	{
		if(isInit_)
		{
			return self_;
