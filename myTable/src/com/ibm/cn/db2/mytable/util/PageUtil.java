...
public class PageUtil {
	...
	private static String bulidHref( String query, int page, String hrefName ){
		...
		String strTemp = "<a href=\"javascript:void(0);\" onclick=\"sendAjax('/myTable/pagination.do?page=" + page + "&query=" + query + "', processConent2StateChangeWithClickable);\">" + hrefName + "</a>";
