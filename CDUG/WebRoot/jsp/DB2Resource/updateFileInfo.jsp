...
<html>
	...
	<%
		if (!((user_session.getUser_access() == 2)||(user_session.getUser_access() == 1))) {
	%>
																					...
																					<tr>
																						<td class="Text" align="left">
																							...
																							<form name="theForm"
																								...
																								%>
																								<input type="text" id="oldfilename" class="Text" size="45" style="border: 0;"
																								...
																								<br><br>
																								<input type=hidden name="tag" value="normal">
