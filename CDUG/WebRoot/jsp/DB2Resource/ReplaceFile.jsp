	...
	<head>
		...
		function PicUpload(){
			if(document.picUploadForm.pic.value == "")
			{
				...
				document.picUploadForm.action='/CDUG/servlet/ReplaceFile?&fname='+fname+'&username='+username+'&useraccess='+useraccess+'&oriname='+oriname+'&old_date='+old_date+'&tag=normal';
				return true;
				}
			}
		</SCRIPT>
																				...
																				<table>
																					...
																					<tr>
																						<td width="100%"
																							...
																							<span class="title"
																								style="color: rgb(255, 255, 255);">DB2资源替换</span>
																						</td>
																					</tr>
																					<tr>
																						<td>
