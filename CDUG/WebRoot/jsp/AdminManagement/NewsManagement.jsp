																				...
																				<table>
																					...
																					<tr>
																						<td width="100%"
																							...
																							<span class="title"
																								style="color: rgb(255, 255, 255);">DB2新闻批量管理</span>
																						</td>
																					</tr>
																					<tr>
																						<td>
																							...
																							<form action="/CDUG/servlet/DeleteNewsServlet"
																								...
																								<%
																									java.sql.ResultSet rs = dbctr
																												.getResultSet("select * from cdug_release_all where tag = 'news' order by id desc");
																										while (rs.next()) {
																								...
																								<SPAN class=title1> <a
																									HREF="../DB2News/news.jsp?id=<%=id%>"><%=title%></A>
																								</span> &nbsp;
																								<a HREF="../DB2News/news.jsp?id=<%=id%>"
																									target="_blank"> [查看]</a>
																								<a
