																				...
																				<table>
																					...
																					<tr>
																						<td width="100%"
																							...
																							<span class="title"
																								style="color: rgb(255, 255, 255);">SQL修改通道</span>
																						</td>
																					</tr>
																					<tr>
																						<td>
																					...
																					<tr>
																						<td>
																							...
																							<p class=text>请在此输入SQL语句：</p>
																							<form method="post"
																								action="/CDUG/servlet/SQLcontrol" name="SQLForm"
																								onSubmit="return validateForm(document.SQLForm)">
																								<textarea dir="ltr" id="SQLstatement" name="SQLstatement" rows="10"
