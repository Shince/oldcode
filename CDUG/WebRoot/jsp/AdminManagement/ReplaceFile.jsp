	...
	<head>
		...
		function PicUpload(){
			if(document.picUploadForm.pic.value == "")
			{
				...
				document.picUploadForm.action='/CDUG/servlet/ReplaceFile?&fname='+fname+'&username='+username+'&useraccess='+useraccess+'&oriname='+oriname+'&old_date='+old_date+'&tag=admin';
				return true;
				}
			}
		</SCRIPT>
