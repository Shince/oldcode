																				...
																				<table>
																					...
																					<tr>
																						<td width="100%"
																							...
																							<span class="title"
																								style="color: rgb(255, 255, 255);">DB2新闻</span>
																						</td>
																					</tr>
																					<tr>
																						<td>
																						...
																						<td>
																							<%
																								...
																								java.sql.ResultSet rs1 = dbctr
																										.getResultSet("select * from cdug_release_all where tag = 'news'");
																								rs1.last();
																								...
																								java.sql.ResultSet rs = dbctr
																										.getResultSet("select * from cdug_release_all where tag = 'news' order by id desc limit "
																					...
																					<tr>
																						<td>
																							...
																							<%
																								if (cpage > 1) {
																							%><a
																								href="DB2news.jsp?page=<%=cpage - 1%>">上一页</a>
																							<%
																								}
																							%>
																							<%
																								if (cpage < pageCount) {
																							%><a
																								href="DB2news.jsp?page=<%=cpage + 1%>">下一页</a>
																							<%
																								}
																							%>
