																				...
																				<table>
																						...
																						<td>
																							<form action="/CDUG/servlet/Deletenews"
																								...
																								<input type="submit" class="wpsButtonText"
																									style="width: 95px;" name="delete" value="删除新闻">
																								<input type="button" class="wpsButtonText"
																									style="width: 95px;" name="edit" id="edit"
																									value="编辑新闻" onClick="return EditNews()">
																								<%
																									}
																								%>
																					...
																					<tr>
																						<td>
																							...
																							<a href='/CDUG/jsp/DB2news/DB2news.jsp'> <img
																									src='/CDUG/backbtn.gif' border=0 align=right>
																							</a>
																						</td>
																					</tr>
																				</table>
