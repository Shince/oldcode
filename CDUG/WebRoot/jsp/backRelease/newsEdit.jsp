...
<html>
	...
	<body onLoad="initEditor('text')">
																				...
																				<table width="100%" align="center">
																					...
																					<tr>
																						<td width="100%"
																							...
																							if (!((user_session.getUser_access() == 2) || a_name.equals(username))) {
																							%>
		...
		javascript:parent.location='/CDUG/index.jsp'
																							...
																							%>
																							<span class="title"
																								style="color: rgb(255, 255, 255);">编辑DB2新闻</span>
																							<%
																								} else if (tag.equals("events")) {
																							%>
																							<span class="title"
																								style="color: rgb(255, 255, 255);">编辑CDUG事件</span>
																							<%
																								}
																							%>
																						</td>
																					...
																					<%
																							java.sql.ResultSet rs = dbctr
																									.getResultSet("select * from cdug_release_all where id="
																											+ id);
																							if (rs.next()) {
																								title = rs.getString("title_text");
																								text = rs.getString("text_text");
																					...
																					<tr>
																						<td class="wpsFieldText" align="left">
																							<form name="newsForm"
																								action="/CDUG/servlet/Editnews" method="POST"
																								...
																								<input dir="ltr" type="text" size="60"
																									name="title" id="title" value="<%=title%>"  maxlength="65"/>
																								<br />
																								<br>
																								编辑内容:
																								...
																								<textarea name="text" id="text" rows="10"
																									cols="100" wrap="hard"><%=text%></textarea>
																								<br>
																								<br>
