...
public class EventsRss extends HttpServlet {
	static String inFile = "C:\\Apache Software Foundation\\Tomcat 5.5\\webapps\\CDUG\\rss\\eventsrss.xml"; 
	static String outFile = "C:\\Apache Software Foundation\\Tomcat 5.5\\webapps\\CDUG\\rss\\eventsrss.xml"; 
	...
	throws ServletException, IOException {
			...
			try{
				while(rs.next()){
					...
					link_item.appendChild(doc.createTextNode("http://www.db2china.org/CDUG/jsp/CDUGEven/news.jsp?id="+news_id)); 
