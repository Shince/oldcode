...
public class NewsRss extends HttpServlet {
	static String inFile = "C:\\Apache Software Foundation\\Tomcat 5.5\\webapps\\CDUG\\rss\\newsrss.xml"; 
	static String outFile = "C:\\Apache Software Foundation\\Tomcat 5.5\\webapps\\CDUG\\rss\\newsrss.xml"; 
	...
	throws ServletException, IOException {
			...
			try{
				while(rs.next()){
					...
					link_item.appendChild(doc.createTextNode("http://www.db2china.org/CDUG/jsp/DB2news/news.jsp?id="+news_id)); 
