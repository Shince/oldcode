...
public class Events extends HttpServlet {
	...
	throws ServletException, IOException {
			...
			if(!(useraccess.equals("1")||useraccess.equals("2"))){
				...
				if(flag){
					response.getWriter().println("<head></head><body onload=\"javascript:parent.location='/CDUG/jsp/backRelease/eventsnewsbackRelease.jsp';alert('事件发布成功！');\"></body>");	
				}
				else{
				response.getWriter().println("<head></head><body onload=\"javascript:parent.location='/CDUG/jsp/backRelease/eventsnewsbackRelease.jsp';alert('事件发布失败！');\"></body>");
				}
				dbctr.close();
			}
		}
